...
#foreach (COMPONENT ${_openexr_components})
    ...
    #              PATHS "/home/sidney/vcpkg/installed/x64-linux/lib") #${OPENEXR_LIBRARY_DIR})
    # Again, with no directory restrictions
    #find_library (OPENEXR_${UPPERCOMPONENT}_LIBRARY ${FULL_COMPONENT_NAME})
    # Try again without the version
    #set (FULL_COMPONENT_NAME ${COMPONENT})
    #find_library (OPENEXR_${UPPERCOMPONENT}_LIBRARY ${FULL_COMPONENT_NAME}
    #              PATHS "/home/sidney/vcpkg/installed/x64-linux/lib")
    # One more time, with no restrictions
    #find_library (OPENEXR_${UPPERCOMPONENT}_LIBRARY ${FULL_COMPONENT_NAME})
#endforeach ()

set(OPENEXR_IMATH_LIBRARY /home/vsts/work/1/s/vcpkg/installed/x64-linux/lib/libImath-2_2.a)
set(OPENEXR_IEX_LIBRARY /home/vsts/work/1/s/vcpkg/installed/x64-linux/lib/libIex-2_2.a)
set(OPENEXR_HALF_LIBRARY /home/vsts/work/1/s/vcpkg/installed/x64-linux/lib/libHalf.a)
set(OPENEXR_ILMTHREAD_LIBRARY /home/vsts/work/1/s/vcpkg/installed/x64-linux/lib/libIlmThread-2_2.a)
set(OPENEXR_ILMIMF_LIBRARY /home/vsts/work/1/s/vcpkg/installed/x64-linux/lib/libIlmImf-2_2.a)

message("DEBUG - IMAT_LIBRARY ${OPENEXR_IMATH_LIBRARY}")
